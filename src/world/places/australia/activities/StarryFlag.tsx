...
import { burst, ChoiceCards, DragArea, Draggable, DropZone, numberWord, say, shuffle, sounds, useAlive, wait } from '../../../../sdk'
      ...
      <div style={{ position: 'relative', height: '100%', aspectRatio: '1', maxWidth: '100%' }}>
        ...
        {SKY.map((s, i) => {
          ...
          return (
            ...
            >
              <img src={art.star} alt="" style={{ width: '100%', height: '100%', objectFit: 'contain', filter: on ? 'none' : 'saturate(0.4) brightness(1.3)' }} />
